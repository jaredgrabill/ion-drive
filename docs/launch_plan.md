...
| 2026-07-14 | Lane 3 §5 (prep) + Lane 4 §1–2, §4 (prep) | Demo-asset script drafted (owner records/approves); `docs/launch/landing-zone.md` (GitHub settings checklist + pinned first-run discussion draft), `docs/launch/posts.md` (Show HN, r/selfhosted, MCP-community, X/Bluesky thread, MCP directory listing — all owner-reviewed before posting), `docs/launch_log.md` scaffold (users + friction→fix ledger + go/no-go note). |
